    ...
    <html>  
       ...
       <?php  echo "Dr.", $dname; ?>
        ...
        <td>
         ...
         <td><input type="submit" required value="Request Approved" name='<?php echo $row['rid']; ?>'></td>
        <td><input type="submit" required value="Request Denied" name='<?php echo $row['rid']; ?>'> </td>
           </form>
         </tr>
        </table>
        </html>
